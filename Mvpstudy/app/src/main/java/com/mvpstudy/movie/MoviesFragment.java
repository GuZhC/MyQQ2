...
import com.mvpstudy.MainActivity;
import com.mvpstudy.R;
import com.mvpstudy.beans.Movie;
import com.mvpstudy.moviedetail.MovieDetailActivity;
...
public class MoviesFragment extends Fragment implements MoviesContract.View{
    ...
    public void onAttach(Context context) {
        ...
        Log.d(MainActivity.TAG,TAG + "Onttach: "+context.getClass().getSimpleName());
        if (mPresenter!= null){
            mPresenter.start();
        }
    }
    ...
    @Override
    public void ShowMovieAatailUi(String movieName) {
    ...
    static class MoviesAdapter extends RecyclerView.Adapter<MoviesViewHolser>{
        ...
        @Override
        public MoviesViewHolser onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(context).inflate(layoutResId,parent,false);
            return new MoviesViewHolser(itemView);
        }

        @Override
        public void onBindViewHolder(MoviesViewHolser holder, int position) {
...
//        }
    ...
    static class MoviesViewHolser extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MoviesViewHolser(View itemView) {
            super(itemView);
        ...
        public void updateMovie(Movie movie){
            ...
            if (average == 0.0){
                ...
                mMovieRatingAverage.setText(context.getResources().getString(R.string.no_note));
            }else {
